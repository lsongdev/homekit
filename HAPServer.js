...
var tlv               = require("./lib/util/tlv");
var hkdf              = require("./lib/util/hkdf");
var once              = require('./lib/util/once');
var encryption        = require("./lib/util/encryption");
var EventedHTTPServer = require("./lib/eventedhttp");
...
util.inherits(HAPServer, EventEmitter);
