...
Characteristic.prototype.toHAP = function(opt) {
  ...
  if (!isNaN(parseInt(this.props.minValue))) value = Math.min(this.props.minValue, value);
  if (!isNaN(parseInt(this.props.maxValue))) value = Math.max(this.props.maxValue, value);
  ...
  switch (this.props.format) {
    ...
    case Characteristic.Formats.FLOAT:
      ...
      break;
    default:
      // console.error('[Characteristic#toHAP] unknow format: %s', this.props.format);
      break;
  }
