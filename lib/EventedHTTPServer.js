...
const debug        = require('debug')('EventedHTTPServer');
...
util.inherits(EventedHTTPServer, EventEmitter);
...
util.inherits(EventedHTTPServerConnection, EventEmitter);
...
module.exports = EventedHTTPServer;